...
Given the following passages, please answer the question step by step.
...
Please provide a step-by-step reasoning before giving the final answer.
''',
    'QA_queryCoT_to_answer': '''
Question: {question}
Chain of Thought: {CoT}
Please provide the final answer (just the option letter).
'''
}
...
''')
#Template()的调用是因为这里使用了Jinja2模板引擎来构建提示词（prompt），可维护性好
